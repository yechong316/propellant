...
'\xb9\xcc\xcc\xe5\xb7\xa2\xb6\xaf\xbb\xfa\xb1\xbe\xd6\xca\xcc\xd8\xd0\xd4\xb7\xd6\xce\xf6\xc8\xed\xbc\xfe-\xc7\xb0\xc6\xda\xd4\xa4\xb4\xa6\xc0\xed',
        ...
        vf1 = FXVerticalFrame(HFrame_10, FRAME_SUNKEN|FRAME_THICK|LAYOUT_FILL_X,
            0,0,0,0, 0,0,0,0)
        vf1.setSelector(99)
        table = AFXTable(vf1, 6, 4, 6, 4, form.elastic_tempKw, 0, AFXTABLE_EDITABLE|LAYOUT_FILL_X)
        ...
        table.setLeadingRowLabels("Young's Modulus\tPossion's Ratio\tTemp")
        table.setStretchableColumn( table.getNumColumns()-1 )
        table.showHorizontalGrid(True)
        table.showVerticalGrid(True)
        table.setItemFloatValue(1, 1, 5143.68)
        table.setItemFloatValue(1, 2, 0.271)
        table.setItemFloatValue(1, 3, 306)
        table.setItemFloatValue(2, 1, 4292)
        table.setItemFloatValue(2, 2, 0.28)
        table.setItemFloatValue(2, 3, 316)
        table.setItemFloatValue(3, 1, 3530)
        table.setItemFloatValue(3, 2, 0.271)
        table.setItemFloatValue(3, 3, 326)
